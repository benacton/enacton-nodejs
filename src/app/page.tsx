export default function Home() {
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <div className="title">
        <h1>Welcome to Enacton!</h1>
      </div>
      <p>Originally a product-based software developer, EnactOn has evolved into one of the best software development companies, catering to our global clientele from over 62+ countries. We stand out for our attention to detail, one-stop solutions, and ability to simplify complex problems, all while offering affordable, scalable solutions.</p>
      <p>
